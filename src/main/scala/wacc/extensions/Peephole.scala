...
object Peephole {
  ...
  /* Removes instructions of the form
      ...
      sub r0, r0, 0
  */
  def removeRedundantSubAdd(instr: Instruction, remaining: List[Instruction]): (List[Instruction], Boolean) = {
    instr match {
  ...
  */
  ...
  /* Removes instructions of the form
      mov r0, r0
  */
  def removeRedundantMov(instr: Instruction, remaining: List[Instruction]): (List[Instruction], Boolean) = {
    instr match {
  ...
  /* Combines instructions of the form
      ...
      add r0, r0, #1
  */
  def combineMovAdd(instr: Instruction, remaining: List[Instruction]): (List[Instruction], Boolean) = {
    (instr, getInstruction(remaining)) match {
  ...
  */
  ...
  /* Combines instructions of the form
      ...
      mov r2, r1
  */
  def combineDoubleMov(instr: Instruction, remaining: List[Instruction]): (List[Instruction], Boolean) = {
  ...
  /* Remove redundant str ldr pairs
    ...
    OR
      ...
      str r0, [r1]
  */
  def removeRedundantStrLdr(instr: Instruction, remaining: List[Instruction]): (List[Instruction], Boolean) = {
    (instr, getInstruction(remaining)) match {
  ...
  /* Removes the first ldr instruction when instructions are of the form
      ...
      ldr r0, [r2]
  */
  def removeRedundantLdr(instr: Instruction, remaining: List[Instruction]): (List[Instruction], Boolean) = {
    (instr, getInstruction(remaining)) match {
