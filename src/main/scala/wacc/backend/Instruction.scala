...
case class AddInstr(reg: Register, operand1: Register, operand2: Operand, updateFlags: Boolean = false) extends Instruction
case class SubInstr(reg: Register, operand1: Register, operand2: Operand, updateFlags: Boolean = false) extends Instruction
